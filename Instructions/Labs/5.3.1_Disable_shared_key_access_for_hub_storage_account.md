---
lab:
  title: 'AI Ready Governance hands-on exercise: Disable shared-key access for a Microsoft Foundry hub storage account'
  description: Disable shared-key access for a Microsoft Foundry hub storage account.
  duration: 15 minutes
  level: 500
  islab: true
  primarytopics:
