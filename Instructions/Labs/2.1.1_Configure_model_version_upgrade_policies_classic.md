---
lab:
  title: 'AI Ready Governance hands-on exercise: Configure model version upgrade policies
    (classic)'
  description: Microsoft Foundry regularly releases new model versions to incorporate
    the latest features and improvements from key model providers in the industry.
    Customers can choose to start with a particular version and stay on it or to automatically
