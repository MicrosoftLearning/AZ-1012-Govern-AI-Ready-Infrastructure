---
lab:
  title: 'AI Ready Governance hands-on exercise: Configure content filters with jailbreak protection (new)'
  description: Configure content filters with jailbreak protection.
  duration: 20 minutes
  level: 300
  islab: true
  primarytopics:
