# AI Ready Governance hands-on exercise: Configure content filters with jailbreak protection (new)
...
2. On the **All resources** page of the Azure AI Foundry portal, select **Create new**.
3. On the **Create project** pane, ensure that the **Microsoft Foundry resource** option is selected and then select **Next**.
4. On the **Create a project** pane, expand the **Advanced options** section and perform the following tasks:
   ...
   * In the **Region** drop-down list, select the Azure region in which you intend to provision the resource and the corresponding project.
   * Select **Create**.

   **Note**: Wait until the resource and its default project are provisioned. This might take about one minute. Once the project is created, the web browser should display the **Welcome** page of the Microsoft Foundry project. If needed, turn the **New Foundry** switch at the top of the page to the **On** position and verify that the project name appears in the upper left corner of the page.
...
3. Select the **Microsoft.Default** entry and, on the **Microsoft.Default** pane on the right side, expand the **Content safety** section.
4. In the **Content safety** section, review the entries in the **Risk type** (all set to **Medium blocking**), **Intervention point** (all set to **User input, Output**), and **Action** (all set to **Block**) columns.
5. Select the **Microsoft.DefaultV2** entry and, on the **Microsoft.DefaultV2** pane on the right side, expand the **Jailbreak** and **Content safety** sections.
6. Note that the **Content safety** section is the same as that for **Microsoft.Default**, but the **Jailbreak** section mitigates the **Jailbreak** risk type, applying **Block** at the **User input** **Intervention point**.
...
3. On the **Create guardrail controls** pane, in the **Add controls** section, perform the following tasks:
...
4. In the **Select agents and models** section, perform the following tasks:
...
5. In the **Review** section, perform the following tasks:
...
3. On the **content-filter-project-new-RG** page, select **Delete resource group**, on the **Delete a resource group** pane, in the **Enter resource group name to confirm deletion** text box, enter **content-filter-project-new-RG**, select **Delete**, and, when prompted for confirmation, select **Delete** again.
