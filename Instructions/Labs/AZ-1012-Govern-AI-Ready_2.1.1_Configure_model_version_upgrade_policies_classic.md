# AI Ready Governance hands-on exercise: Configure model version upgrade policies (classic)
...
1. On the **Create a project** pane, expand the **Advanced options** section and perform the following tasks:
   ...
   - Accept the default value of the **Microsoft Foundry resource** (**version-upgrade-project-resource**).
...
### Task 2: Explore Microsoft Foundry model deployment version update settings

1. In the web browser displaying the Microsoft Foundry portal, on the project's **Overview** page, in the vertical menu on the left side, select **Models + endpoints**.
