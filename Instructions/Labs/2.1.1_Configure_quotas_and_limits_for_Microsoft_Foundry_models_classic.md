---
lab:
  title: 'AI Ready Governance hands-on exercise: Configure quotas and limits for Microsoft Foundry models'
  description: This deployment option is available only when using Azure AI hub resources. It allows you to create dedicated endpoints to host a model, accessible through an API. It is limited to a subset of Microsoft Foundry Models and it supports only regional deployments.
  duration: 15 minutes
  level: 300
  islab: true
  primarytopics:
