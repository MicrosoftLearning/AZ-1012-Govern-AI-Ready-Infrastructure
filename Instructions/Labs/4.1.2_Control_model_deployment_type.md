---
lab:
  title: 'AI Ready Governance hands-on exercise: Control model deployment type with
    a custom Azure policy definition'
  description: When using models from Azure AI Foundry and Azure OpenAI with Azure
    AI Foundry, you have the option to implement custom policies to control which
    type of deployment options are available to users. This ability is available for
    both an Azure AI Foundry project and hub-based project.
  duration: 10 minutes
  level: 200
  islab: true
  primarytopics:
